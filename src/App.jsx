      ...
      <div className="relative py-24 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="flex flex-col items-center justify-center mb-12 md:mb-16">
            <div className="w-40 h-40 md:w-56 md:h-56 rounded-[3rem] bg-slate-900 rotate-45 flex items-center justify-center shadow-2xl relative group transition-transform hover:scale-105 duration-500">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {branches.map((b, i) => (
              ...
              >
                ...
                <div className="mt-6 w-8 h-1 bg-slate-100 rounded-full group-hover:w-16 group-hover:bg-blue-200 transition-all"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative h-[85vh] flex flex-col justify-center items-center px-6 text-center bg-slate-50">
        ...
        <div className="relative z-10">
          <div className="w-32 h-32 md:w-48 md:h-48 rounded-full border-4 border-white shadow-xl overflow-hidden mb-8 mx-auto ring-4 ring-blue-50">
            <img src="/utkmangal/assets/img/profile.jpg" alt={profile.name} className="w-full h-full object-cover" />
          </div>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <button onClick={() => setActiveTab('research')} className="px-8 py-3 bg-blue-600 text-white rounded-full font-medium shadow-lg shadow-blue-200 active:scale-95 transition-all">
              View Research
            </button>
    ...
    <div className="py-24 px-6 max-w-6xl mx-auto animate-in fade-in duration-500">
      <div className="mb-20">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
            ...
            <div className="flex gap-4">
                <button className="p-3 bg-slate-100 rounded-2xl text-slate-600 hover:bg-blue-600 hover:text-white transition-all">
                    <TrendingUp size={20} />
                </button>
                <button className="p-3 bg-slate-100 rounded-2xl text-slate-600 hover:bg-blue-600 hover:text-white transition-all">
                    <Search size={20} />
          ...
          {[
            ...
            <div key={i} className="group p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex justify-between items-start mb-6">
                <div className={`w-14 h-14 rounded-2xl ${m.bg} ${m.color} flex items-center justify-center transition-transform group-hover:scale-110`}>
                    <m.icon size={28} />
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
        {publications.map((pub, i) => (
          <div key={i} className="group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-100 transition-all">
            <div className="flex justify-between items-start mb-6">
      ...
      <div className="p-12 rounded-[3rem] bg-blue-600 text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl shadow-blue-200">
          ...
          <a href="https://scholar.google.co.kr/citations?user=Fi5CddUAAAAJ" target="_blank" rel="noreferrer" className="relative z-10 px-10 py-5 bg-white text-blue-600 rounded-2xl font-black shadow-xl hover:scale-105 transition-all flex items-center gap-3 uppercase tracking-widest text-sm">
      ...
      <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
        {experience.map((item, i) => (
          <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all group-hover:border-blue-100">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-xl shadow-sm py-3' : 'bg-transparent py-8'}`}>
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-blue-600 transition-all shadow-xl shadow-slate-900/10 active:scale-95"
          >
            Get In Touch
          </button>
        </div>
          ...
          <div className="py-24 px-6 max-w-4xl mx-auto text-center animate-in fade-in duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
               <a href="mailto:meta.mangal@yonsei.ac.kr" className="group p-10 rounded-[3rem] bg-slate-50 border border-slate-100 flex flex-col items-center hover:bg-blue-600 hover:border-blue-600 transition-all duration-300">
                  <div className="w-16 h-16 rounded-2xl bg-white text-blue-600 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform">
                    <Mail size={32} />
                  </div>
               ...
               <a href="https://github.com/utkmangal" target="_blank" rel="noreferrer" className="group p-10 rounded-[3rem] bg-slate-50 border border-slate-100 flex flex-col items-center hover:bg-slate-900 hover:border-slate-900 transition-all duration-300">
                  <div className="w-16 h-16 rounded-2xl bg-white text-slate-900 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform">
                    <Github size={32} />
                  </div>
