  ...
  return (
    <div className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="text-center mb-12 sm:mb-16">
        ...
        <h2 className="text-4xl md:text-5xl font-black text-[color:var(--text)] mb-6 tracking-tight">
          {t.contact.title}
        </h2>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="ui-card p-8">
            <h3 className="text-xl font-black text-[color:var(--text)] mb-6">
              {lang === 'en' ? 'Contact Information' : '연락처 정보'}
            </h3>
            <div className="space-y-4">
              {contactInfo.map((info, idx) => (
                <div key={idx} className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[color:var(--brand-soft)] text-[color:var(--brand-strong)] flex items-center justify-center flex-shrink-0">
                    <info.icon size={20} />
                  </div>
          ...
          {/* Availability */}
          <div className="ui-soft-panel p-8">
